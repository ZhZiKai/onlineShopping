...
CREATE TABLE `goods` (
  ...
  `carriage` float(10,2) DEFAULT NULL,
...
INSERT INTO `goods` VALUES ('14', '彩色长尾夹', '13', '彩色长尾夹1.jpg&彩色长尾夹2.jpg&彩色长尾夹3.jpg', '文具', '广东惠来', '12.00', '0.00', '2015-03-13', '从广东发货', '25mm彩色长尾夹/长尾票夹 48只/筒');
...
-- ----------------------------
INSERT INTO `shoppingcart` VALUES ('3', '6', '14', '1', '2016-06-04 21:12:10');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('6', 'czy', '3113002295@qq.com', '1234567', '2016-06-04 21:11:58');
